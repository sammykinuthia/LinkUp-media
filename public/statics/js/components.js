...
export function UserProfile(user) {
    const { image, name, username, email, phone, followers, following, posts, id } = user
    ...
    return (`
        <div class="user-profile">
            ...
            <div class="users-details">
                <p>Name: <span class="user-data">${name || ""}</span></p>
                <p>Username: <span class="user-data"> ${username}</span></p>
                <p>Email: <span class="user-data"> ${email}</span></p>
                <p>Phone: <span class="user-data"> ${phone || ""}</span></p>
                ${id === currentUser.id && '<button id="profile-update">update</button>'}
            </div>
        </div>
    `)
}
                    ...
                    <div class="post" }">
                        ...
                        <div class="post-header">
                                ...
                                <div class="post-action">
                                    <svg class="post-action-btn" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="7" cy="2" r="1.5"/><circle cx="7" cy="7" r="1.5"/><circle cx="7" cy="12" r="1.5"/></g></svg>
